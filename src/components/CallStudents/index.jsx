...
import { Checkbox, Pagination, Paper, Typography } from '@mui/material'
...
export default function CallStudents() {
  ...
  useEffect(() => {
    getAcademic_Year(`${semester}?page_size=${pageSize}&search=${searchText}&page=${page}`, response => {
