    ...
    return (
        <ContentWrapper>
            ...
            >
                                            ...
                                            <tr key={index}>
                                                ...
                                                <th style={{ width: "400px" }}>
                                                    ...
                                                    }
                                                    {
                                                        ...
                                                        >
                                                            {listLanguage.Rejected[language]}
                                                        </Button>
                                                    }
                                                    {
                ...
                <BoxFooter>
                    <BoxFooterText>{`${listLanguage.Total[language]} ${allCount} ${listLanguage.Ta[language]},${listLanguage.From[language]} ${pageSize * (page - 1) + 1} ${listLanguage.To[language]} ${pageSize * (page - 1) + teacherGetNbList.length} ${listLanguage.AreShown[language]}`}</BoxFooterText>
