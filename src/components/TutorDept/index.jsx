...
export default function TutorDept() {
  ...
  useEffect(() => {
    setStudents([])
    getStudents(`${accountant_students}?page_size=${pageSize}&page=${page}&search=${searchText}&student__academic_group=${state.id}`, (response) => {
