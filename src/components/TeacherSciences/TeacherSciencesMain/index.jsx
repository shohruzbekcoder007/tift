                        ...
                        <TeacherSciencesButtonBox>
                          ...
                          <Link to={'journal'} state={{ data: elem.id }}>
                            <Button
                              ...
                              startIcon={<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-table" viewBox="0 0 16 16">
                          ...
                          <Link to={"tasks"} state={{ data: elem.id, name: elem.name, type: elem.science_type, parent: elem.parent, science: elem.science }}>
                            <Button
                              variant="contained"
                              size="small"
                              color="secondary"
                          ...
                          <Link to={'addcalendarplan'} state={{data: elem.id, science: elem.science}}>
                            <Button
                              ...
                              startIcon={<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-file-earmark-plus" viewBox="0 0 16 16">
