              ...
              <tbody>
                {
                  nbList.length > 0 ? nbList.map((elem, index) => {
                    return (
                      <tr key={index}>
                        <th data-cell="Vaqt">{elem.lesson_date}</th>
                        <th data-cell="Fan">{elem.science}</th>
                        <th data-cell="Turi">{elem.lesson_type}</th>
                        <th data-cell="Mavzu raqami">{elem.lesson_number}</th>
                        <th data-cell="Mavzu">{elem.lesson_name}</th>
                      </tr>
                    )
                  })
                    :
