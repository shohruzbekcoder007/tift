...
import { BoxBody, ClassScheduleTableWrapper } from '../Payments/styles'
import { TableTHHeader } from '../../DiplomaTable'
import { WrapperInputsCardTwo } from '../Streams/styles'
import AllSelectFullWidth from '../../AllSelectFullWidth'
import study_type from '../../../dictionary/study_type'
import { WrapperBox } from '../AdminUsers/AdminUsersAdd/styles'
import degree from '../../../dictionary/degree'
import { getAcademicGroup, getSemesters } from '../Streams/request'
import { academic_group_short, my_semesters, rating_notebook, users_student } from '../../../utils/API_urls'
import { getOneEmployees } from '../Students/EditEmployees/request'
import { useLocation } from 'react-router-dom'
import AutocompleteJames from '../../AutocompleteJames'
import { PersonalPlanPaper, PersonalPlanWrapper } from '../../PersonalPlan/styles'
import { getStudentRatingNotebook } from '../../PersonalPlan/requests'

export default function ReadingRecovery() {
  ...
  useEffect(() => {
    getStudentRatingNotebook(`${rating_notebook}?student=${state?.StudentID}`, (response) => {
              ...
              <tbody>
                {
                  <tr>
                    ...
                    <th>{StudentData.first_name + " " + StudentData.last_name + " " + StudentData.middle_name}</th>
                    <th></th>
                    <th>{StudentData.course_number}</th>
                    <th>O'qishni ko'chirish</th>
                    <th></th>
                  </tr>
                }
              </tbody>
      ...
      <WrapperBox style={{ width: "100%" }}>
        ...
        <BoxHeader>
          <WrapperInputsCardTwo>
            ...
            <AllSelectFullWidth
              ...
              selectedOptionP={DegreeTypeList[0].value}
        ...
        <BoxHeader>
          ...
          <WrapperInputsCardTwo>
            ...
            <AllSelectFullWidth
              chageValueFunction={val => { }}
              selectedOptionP={StudyTypeList[0].value}
        ...
        <BoxHeader>
          ...
          <WrapperInputsCardTwo>
            ...
            {/* <AllSelectFullWidth
              ...
              selectOptions={[]}
            /> */}
            <AutocompleteJames  selectOptions={[]} chageValueFunction={val => {}}  />
