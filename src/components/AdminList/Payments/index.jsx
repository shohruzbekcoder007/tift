...
export default function Payments() {
  ...
  return (
    <>
      ...
      >
        Umarov Ulug'bek Abdurahmon o'g'li
      </Typography>
      ...
      <BoxTableCard>
        <HeaderWrapper>
          ...
          <WrapperBody>
            <HeaderWrapperH4>Joriy o‘quv yili: </HeaderWrapperH4>
            <HeaderWrapperP>2021-2022</HeaderWrapperP>
          </WrapperBody>
          <WrapperBody>
          ...
          <WrapperBody>
            <HeaderWrapperH4>Shartnoma summasi:</HeaderWrapperH4>
            <HeaderWrapperP>1</HeaderWrapperP>
          </WrapperBody>
          <WrapperBody>
            <HeaderWrapperH4>Yillik shartnoma summasi::</HeaderWrapperH4>
            <HeaderWrapperP>6 627 840 so‘m</HeaderWrapperP>
          </WrapperBody>
          <WrapperBody>
            <HeaderWrapperH4>Semestr shartnoma summasi: </HeaderWrapperH4>
            <HeaderWrapperP>3 313 920 so‘m</HeaderWrapperP>
          </WrapperBody>
          <WrapperBody>
            <HeaderWrapperH4>Oylik shartnoma summasi: </HeaderWrapperH4>
            <HeaderWrapperP>552 320 so'm</HeaderWrapperP>
          </WrapperBody>
          <WrapperBody>
            <HeaderWrapperH4>To'langan: </HeaderWrapperH4>
            <HeaderWrapperP>0 so'm (0%)</HeaderWrapperP>
          </WrapperBody>
          <WrapperBody>
            <HeaderWrapperH4>Oylik to'lov holati: </HeaderWrapperH4>
          </WrapperBody>
          <WrapperBottom>
            {
              [1, 2, 3, 4, 5, 6, 1, 2].map((elem, index) => {
                return (
                  <tr key={index}>
                    <Button
                      variant="contained"
        ...
        <div style={{ width: '61%', margin: "1rem 0" }}>
          <Paper
            elevation={0}
            sx={{
              width: '100%',
                          ...
                          <tr key={index}>
                            ...
                            <th>
                              ...
                              <Button
                                ...
                                startIcon={<svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <g clip-path="url(#clip0_1221_29003)">
