...
import { fakultyCreate, getDekanList, getRoles } from './request'
        ...
        >
          <ModalBox>
            ...
            <ModalSelectWrapper>
              ...
              <AllSelectFullWidth
                chageValueFunction={val => {setRequestData(prev => {
                  return {
                    department_user: val,
            ...
            <ModalSelectWrapper>
              ...
              >
                ...
                <CustomizedInputSimple callback_func={(val) => { setRequestData(prev => {
                  return {
                    department_user: prev.department_user,
                    faculty_type: prev.faculty_type,
                    name: prev.name,
