  ...
  return (
    <>
      ...
      >
        ...
        <BoxBody>
          <ClassScheduleTableWrapper>
            <table>
              ...
              <tbody>
                {
                  Buildings.length > 0 ? Buildings.map((elem, index) => {
                    return (
                     <SimpleBuilding key={index} elem={elem} callback_func={(val) => setStatus(val)} status={Status}/>
                    )
                  })
                    :
                    <tr>
        ...
        <BoxFooter>
          <BoxFooterText>{`Jami ${allCount} ta, ${pageSize * (page - 1) + 1} dan ${pageSize * (page - 1) + Buildings.length} gachasi ko'rsatilmoqda`}</BoxFooterText>
          ...
          <ModalBox>
            ...
            <ModalSelectWrapper>
              ...
              >
                ...
                <CustomizedInputSimple callback_func={(val) => { setName(val) }} placeholder="nomi"/>
            </ModalSelectWrapper>
            <ModalButtons>
              <Button
...
const SimpleBuilding = ({ elem, callback_func, status }) => {
  const [open, setOpen] = React.useState(false);
  const handleOpen = () => setOpen(true);
  const handleClose = () => setOpen(false);
  ...
  const handleDelete = () => {
    DeleteBuilding(`${building}${elem.id}/`, (response) => {
      callback_func(false)
      handleClose()
    }, (error) => {
      console.log(error)
        ...
        >
          <ModalBox>
            ...
            <ModalSelectWrapper>
              ...
              >
                Nomi                         </Typography>
                <CustomizedInputSimple callback_func={(val) => { setName(val) }} placeholder="nomi" defaultValue={elem.name} />
            </ModalSelectWrapper>
            <ModalButtons>
              <Button
                sx={{ width: "50%", textTransform: "none" }}
