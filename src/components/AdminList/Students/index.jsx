...
import { academic_group_short, directions, users_student } from '../../../utils/API_urls'
...
export default function Students() {
  ...
  useEffect(() => {
    getUsers(`${users_student}?page_size=${pageSize}&search=${searchText}&page=${page}&direction=${DirectionID}&academic_group=${GroupID}`, response => {
  ...
  }, [page, pageSize, searchText, deleted,DirectionID,GroupID])
  // ======
  ...
  useEffect(() => {
    ...
    getAcademicGroup(`${academic_group_short}?page_size=1000&direction=${DirectionID}`, (response) => {     
      // setDirections(response.results)
