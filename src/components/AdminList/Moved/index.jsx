...
export default function Moved() {
  ...
  useEffect(() => {
    setStudents([])
    getUsers(`${additional_student}?page_size=${pageSize}&search=${searchText}&page=${page}&specialty=${DirectionID}&academic_group=${GroupID}&year_of_admission=${AcademekYear}&degree=${DegreeSelect}&study_type=${'moved'}&gender=${Gender}&form_of_payment=${FormPayment}`, response => {
    ...
    <>
      ...
      >
        <BoxHeader>
          ...
          <AttendSearchButton>
            <a href={host + `/api/v1/documents/admin-students-contingent/?year=${AcademekYear}&study_type=${'moved'}&direction=${DirectionID}&degree=${DegreeSelect}&academic_group=${GroupID}&form_of_payment=${FormPayment}`} target='_blank'>
              <Button
                variant="contained"
                sx={{
                  width: "90px",
...
const OneStudent = ({ student, setDeleted }) => {
  ...
  return (
    <tr>
      ...
      <th>
        <Link to={'moved'} state={{ StudentID: student.id }}>
          <Button
            variant="contained"
            sx={{
              borderRadius: "10px",
