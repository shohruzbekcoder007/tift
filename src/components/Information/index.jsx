    ...
    <ContentWrapper>
      <Info_body>
        <HeaderWrapper>
          ...
          <HeaderWrapperBottom>
            <div className="wrapper_body">
              <h4>{languageList.BirthDate[language]}:</h4>
              <p>10-06-2003</p>
            </div>
            <div className="wrapper_body">
              <h4>{languageList.Gender[language]}</h4>
              <p>Erkak</p>
            </div>
            <div className="wrapper_body">
              <h4>{languageList.RatingBook[language]}:</h4>
              <p>22403-21</p>
            </div>
            <div className="wrapper_body">
              <h4>{languageList.Address[language]}:</h4>
              <p>Moskva, Toshkent</p>
            </div>
            <div className="wrapper_body">
              <h4>{languageList.AddressTemporal[language]}:</h4>
              <p>Moskva, Toshkent</p>
            </div>
          </HeaderWrapperBottom>
        </HeaderWrapper>
        <HeaderWrapper margin='true'>
          <div className="wrapper_body">
            <h4>{languageList.Field[language]}:</h4>
            <p>sun'iy intellekt</p>
          </div>
          <div className="wrapper_body">
            <h4>{languageList.StudyLang[language]}:</h4>
            <p>UZ</p>
          </div>
          <div className="wrapper_body">
            <h4>{languageList.Degree[language]}:</h4>
            <p>Bakalavr</p>
          </div>
          <div className="wrapper_body">
            <h4>{languageList.EducationForm[language]}:</h4>
            <p>Kunduzgi</p>
          </div>
          <div className="wrapper_body">
            <h4>{languageList.Course[language]}:</h4>
            <p>2</p>
          </div>
          <div className="wrapper_body">
            <h4>{languageList.Group[language]}: </h4>
            <p>224-21 SIo'</p>
          </div>
          <div className="wrapper_body">
            <h4>{languageList.Coach[language]}:</h4>
            <p>Jonqobilov Mirjalol</p>
          </div>
          <div className="wrapper_body">
            <h4>{languageList.Scholar[language]}:</h4>
            <p>Yo’q</p>
          </div>
        </HeaderWrapper>
      </Info_body>
