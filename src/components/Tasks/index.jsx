...
export default function Tasks() {
  ...
  const [tasktypeVal, setTasktype] = useState('joriy')
  ...
  return (
    <>
      <BoxHeader>
        ...
        >
          Vazifalar - {state.name ?? tasksList?.[0]?.group_name} / Fan - {state.science}
        </Typography>
        <Button
          variant="contained"
          sx={{
        ...
        <ModalBox>
          ...
          <ModalSelectWrapper>
            ...
            <AllSelectFullWidth
              ...
              selectedOptionP={tasktype[0].value}
...
const ItemTasks = ({ elem, index }) => {
  ...
  return (deleted ? <></> :
    <tr >
      ...
      <th data-cell="Guruh">{elem.group_name}</th>
