...
export default function TeacherStatistic() {
    ...
    <ContentWrapper>
      <TeacherStatisticWrapper>
        <TeacherStatisticWrapperHeader>
          ...
          <WrapperHeaderRight>
            <svg xmlns="http://www.w3.org/2000/svg" width="155" height="85" fill="currentColor" className="bi bi-calendar2-check" viewBox="0 0 16 16">
  ...
  <path fillRule="evenodd" d="M15 2a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2zM0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2zm8.5 2.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V4.5z"/>
      ...
      <TeacherStatisticWrapper>
        <TeacherStatisticWrapperHeader>
          <WrapperHeaderLeft>
            <h2>{ScienceListCount.controls}</h2>
            <p>Oraliq nazorat</p>
          </WrapperHeaderLeft>
          <WrapperHeaderRight>
      ...
      <TeacherStatisticWrapper>
        <TeacherStatisticWrapperHeader>
          <WrapperHeaderLeft>
            <h2>{ScienceListCount.end_controls}</h2>
            <p>Yakuniy nazorat</p>
          </WrapperHeaderLeft>
          <WrapperHeaderRight>
