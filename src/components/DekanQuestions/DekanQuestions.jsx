...
import { IntermediateBoxHeader } from '../StatistikaList/Intermediate/styles'
import { Link } from 'react-router-dom'
export default function DekanQuestions() {
  return (
    <>
      <Paper
        elevation={0}
